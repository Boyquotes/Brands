...
namespace Brands\Model\Map;

use Brands\Model\Brand;
use Brands\Model\BrandQuery;
...
class BrandTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Brands.Model.Map.BrandTableMap';
     ...
     */
    const OM_CLASS = '\\Brands\\Model\\Brand';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Brands.Model.Brand';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Nom', 'Description', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'nom', 'description', ),
        self::TYPE_COLNAME       => array(BrandTableMap::ID, BrandTableMap::NOM, BrandTableMap::DESCRIPTION, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'NOM', 'DESCRIPTION', ),
        self::TYPE_FIELDNAME     => array('id', 'nom', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Nom' => 1, 'Description' => 2, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'nom' => 1, 'description' => 2, ),
        self::TYPE_COLNAME       => array(BrandTableMap::ID => 0, BrandTableMap::NOM => 1, BrandTableMap::DESCRIPTION => 2, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'NOM' => 1, 'DESCRIPTION' => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nom' => 1, 'description' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Brands\\Model\\Brand');
        $this->setPackage('Brands.Model');
    ...
    {
        $this->addRelation('Product', '\\Brands\\Model\\Thelia\\Model\\Product', RelationMap::MANY_TO_ONE, array('id' => 'id', ), null, null);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BrandTableMap::NOM);
            $criteria->addSelectColumn(BrandTableMap::DESCRIPTION);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Brands\Model\Brand) { // it's a model object
